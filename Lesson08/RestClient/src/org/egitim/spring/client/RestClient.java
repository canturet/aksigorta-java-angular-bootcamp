...
public class RestClient {
	...
	private static final String SERVICE_URL = "http://localhost:8081/egitim/sorgu/kisi";
	...
	public void serviceKisiTumListe() {
		...
		ResponseEntity<String> responseEntity = restTemplate.exchange(SERVICE_URL + "/tumListe", HttpMethod.GET,
